...
def parse_opt():
    ...
    parser.add_argument('--input_image_h5', type=str, default='data/cocotalk_image.h5',
                    help='path to the h5file containing the preprocessed image')
    parser.add_argument('--cnn_model', type=str, default='resnet101',
                    help='resnet')
    parser.add_argument('--cnn_weight', type=str, default='data/imagenet_weights/resnet101.pth',
    ...
    parser.add_argument('--checkpoint_path', type=str, default='log_st',
