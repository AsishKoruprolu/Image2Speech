...
`prepro_images.py` resize all the images and save them in a h5 file.
...
```bash
$ python train.py --id st --caption_model show_tell --input_json data/cocotalk.json --input_image_h5 data/cocotalk_image.h5 --input_label_h5 data/cocotalk_label.h5 --batch_size 10 --learning_rate 5e-4 --learning_rate_decay_start 0 --scheduled_sampling_start 0 --checkpoint_path log_st --save_checkpoint_every 6000  --cnn_model resnet101 --cnn_weight data/imagenet_weights/resnet101.pth --val_images_use 5000 --max_epochs 25
```
...
```bash
$ python eval.py --model_path model.pth --cnn_model_path model-cnn.pth --infos_path infos.pkl --image_folder blah --num_images 10
```
...
```bash
$ python eval.py --dump_images 0 --num_images 5000 --model_path model.pth --cnn_model_path model-cnn.pth --infos_path infos.pkl --language_eval 1
```
